...
// every admin create/edit page repeats.
export function useAdminResourceForm<TForm extends Record<string, unknown>>(
    initialValues: TForm,
    ...
    const { clientErrors, attemptSubmit } = useFormValidation(form, rules);
    ...
    return { form, clientErrors, submit };
}
